...
VALID_TRANSITIONS: dict[PipelineState, set[PipelineState]] = {
    ...
    PipelineState.TRANSCRIBING: {PipelineState.CONTEXT_INJECTION, PipelineState.EXTRACTING_INTENT, PipelineState.FAILED},
    PipelineState.CONTEXT_INJECTION: {PipelineState.EXTRACTING_INTENT, PipelineState.FAILED},
