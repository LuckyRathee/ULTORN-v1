"""
Typed exception classes for the Ultron pipeline.
...
def create_error_from_code(code: str, message: str, details: Optional[dict] = None) -> UltronError:
    """Create appropriate error instance from error code."""
    error_class = ERROR_CODE_MAP.get(code, UltronError)
